...
select extensions.is((select count(*) from public.location_products where brand_id = '10000000-0000-4000-8000-000000000001' and is_available), 1::bigint, 'stores available products distinctly');
select extensions.is((select count(*) from public.location_products where brand_id = '10000000-0000-4000-8000-000000000001' and not is_available), 1::bigint, 'stores unavailable products distinctly');
select extensions.is((select count(*) from public.location_modifier_options where brand_id = '10000000-0000-4000-8000-000000000001' and is_available), 1::bigint, 'stores available options distinctly');
select extensions.is((select count(*) from public.location_modifier_options where brand_id = '10000000-0000-4000-8000-000000000001' and not is_available), 1::bigint, 'stores unavailable options distinctly');
